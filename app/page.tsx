                ...
                <div className="relative z-10 grid md:grid-cols-2 gap-12 items-center">
                    <div className="space-y-6">
                        ...
                        <p className="md:text-xl text-muted-foreground max-w-md leading-relaxed">
                            ...
                            building full-stack and AI-integrated products.
                            National-level hackathon winner with a track record
                            of shipping production-ready applications.
                        </p>
            ...
            >
                <div className="grid justify-between items-end mb-16 gap-4">
                    ...
                    <p className="text-muted-foreground max-w-sm text-left">
                        A collection of full-stack, AI-integrated, and
                ...
                <div className="grid md:grid-cols-12 gap-12">
                    <div className="md:col-span-4">
                        ...
                        <p className="text-muted-foreground mb-8">
                            My preferred weapons of choice for building digital
                            products. Always learning, always evolving.
                        </p>
                ...
                <div className="max-w-2xl justify-self-center">
                    <div className="text-center mb-12">
                        ...
                        <p className="text-muted-foreground">
                            Have a project in mind, an internship opening, or a
                            role to discuss? Send a signal.
                        </p>
                    </div>
